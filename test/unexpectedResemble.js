...
describe('unexpected-resemble', () => {
  ...
  it('should succeed when the comparison is successful', () => expect(peopleJpgPath, 'to resemble', people2JpgPath, 10));

  it('should fail when the comparison is unsuccessful', () => expect(
    () => {
  ...
  describe('with mismatchPercentage in odd camel case', () => {
    it('should succeed when the comparison is successful', () => expect(peopleJpgPath, 'to resemble', people2JpgPath, {
  ...
  it('should compare images provided as data: urls', () => expect(
