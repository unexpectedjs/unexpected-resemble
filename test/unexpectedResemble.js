...
describe('unexpected-resemble', function() {
  ...
  var peopleJpgPath = pathModule.resolve(
    __dirname,
    '..',
    'testdata',
    'People.jpg'
  ...
  var people2JpgPath = pathModule.resolve(
    __dirname,
    '..',
    'testdata',
    'People2.jpg'
  ...
  describe('with mismatchPercentage in odd camel case', function() {
    it('should succeed when the comparison is successful', function() {
      return expect(peopleJpgPath, 'to resemble', people2JpgPath, {
  ...
  it('should compare images provided as data: urls', function() {
    return expect(
