...
module.exports = {
  ...
  installInto: function(expect) {
    ...
    expect.addAssertion('<string|binaryArray> to resemble <any+>', function(
      expect,
      subject,
      otherImage,
      value
      ...
      return expect
        .promise(function(resolve, reject) {
          ...
          if (typeof value !== 'number' && typeof value !== 'undefined') {
            ['ignoreColors', 'ignoreAntialiasing'].forEach(function(
              optionName
            ) {
              if (optionName in value) {
                var ignoreValue = optionName.replace(/^ignore(.)/, function(
                  match,
                  firstChar
                ) {
          ...
          resemble.compare(subject, otherImage, options, function(
            err,
            resemblance
          ) {
            if (err) {
