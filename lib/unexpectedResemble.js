                ...
                return expect.withError(function () {
                    ...
                    expect.fail({
                        diff: function (output, diff, inspect, equal) {
                            ...
                            output.append(err.getDiff(output.format).diff).nl(2);
                            ...
                            Object.keys(imageByName).forEach(function (imageName, i) {
                                output
                                    ...
                                    .text(imageName, 'cyan')
                                    .text(':')
                                    .sp(longestLabelLength - imageName.length)
                                    .sp()
                                    .image(imageByName[imageName], { fallbackToDisc: true });
/*
                                        ...
                                        html: function () {
                                            ...
                                            if (typeof image === 'string') {
                                                this.raw({
                                                    width: 0,
                                                    height: 0,
                                                    content: '<img src="' + image.replace(/"/g, '&quot;') + '">'
                                                });
                                            } else {
